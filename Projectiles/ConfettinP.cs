...
{
    public class ConfettinP : ModProjectile
    {
 
        public override void SetDefaults()
        {
            projectile.name = "Star of Sarah";  //this is the projectile name
            projectile.width = 20;
        ...
        {            
            ...
            {
                projectile.velocity.Y = projectile.velocity.Y + 0.16f;    // projectile fall velocity
