...
{
    public class VanillaArmsDealer : GlobalNPC
    {
        public override void SetupShop(int type, Chest shop, ref int nextSlot)
        {
            switch (type)
            {
                case NPCID.ArmsDealer:  //change Dryad whith what NPC you want
                    ...
                    {
                        shop.item[nextSlot].SetDefaults(mod.ItemType("WeaponFuel"));  //this is an example of how to add your item
                        nextSlot++;
                        shop.item[nextSlot].SetDefaults(ItemID.LunarBar);    //this is an example of how to add a terraria item
                        nextSlot++;
						shop.item[nextSlot].SetDefaults(mod.ItemType("GlitchLordSword"));    //this is an example of how to add a terraria item
                        nextSlot++;
                    }
                    else
                    {    //This make that the npc will always sell this
                        shop.item[nextSlot].SetDefaults(mod.ItemType("TheJolt"));   //this is an example of how to add your item
                        nextSlot++;
                        shop.item[nextSlot].SetDefaults(mod.ItemType("TheConfettin"));   //this is an example of how to add your item
                        nextSlot++;
